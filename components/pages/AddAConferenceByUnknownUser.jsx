...
const AddAConferenceByUnknownUser = () => {
  ...
  const organisationFields = [
    ...
    },
    {
      ...
      uni: "organizationAddress",
      initialValue: "",
      type: "text",
    },
    {
      placeholder: "Organization City",
      labelName: "Organization City",
      uni: "organizationCity",
      initialValue: "",
      type: "text",
    },
    {
      placeholder: "Organization State",
      labelName: "Organization State",
      uni: "organizationState",
      initialValue: "",
      type: "text",
    },
    {
      placeholder: "Organization Country",
      labelName: "Organization Country",
      uni: "organizationCountry",
      initialValue: "",
      type: "text",
    },
  ];
  ...
  const conferenceFields = [
    ...
    },
    {
      ...
      labelName: "Conference Location",
      uni: "conferenceLocation",
      initialValue: "",
      type: "text",
    },
    {
      placeholder: "Conference Date",
      labelName: "Conference Date",
      uni: "conferenceDate",
      initialValue: "",
      type: "date",
    },
    {
      ...
      labelName: "Conference Start Time",
      uni: "startTime",
      initialValue: "",
      type: "time",
    },
  ...
  const committeeFields = [
    {
      placeholder: "Committee Chairman",
      labelName: "Committee Chairman",
      uni: "committeeChair",
      initialValue: "",
      type: "text",
    },
    {
      ...
      labelName: "Committee Members",
      uni: "committeeMembers",
      initialValue: "",
      type: "text",
    },
  ];
  ...
  const speakerFields = [
    ...
    {
      placeholder: "Speakers Affiliation",
      labelName: "Speakers Affiliation",
      uni: "speakers2",
      initialValue: "",
      type: "text",
    },
  ...
  const registrationFields = [
    {
      ...
      labelName: "Registration Open Date",
      uni: "registrationOpenDate",
      initialValue: "",
      type: "date",
    },
    {
      placeholder: "Registration Close Date",
      labelName: "Registration Close Date",
      uni: "registrationCloseDate",
      initialValue: "",
      type: "date",
    },
    {
    ...
    },
    {
      ...
      labelName: "Registration Link",
      uni: "registrationLink",
      initialValue: "",
      type: "text",
    },
  ];
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      setLoading(true);
      const result = await addConferenceFromForm({ ...values });
          ...
          <div className="py-20 bg-white text-black ">
            <Container>
              ...
              >
                {({ values }) => {
                  return (
                    <Form className="flex flex-col pb-7">
                      ...
                      <InputField
                        uni="conferenceDescription"
                        labelName={"Conference Description"}
                        as={"textarea"}
                        ...
                        {({ push, remove }) => (
                          <div className="flex flex-col">
                              ...
                              <div key={i} className="relative flex flex-col">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:my-5 ">
                                  <InputField
                                    uni={`speakers.${i}.name`}
                                    placeholder="Alex"
                                    labelName={`Speaker ${i + 1} name`}
                                  />
                                  <InputField
                                    uni={`speakers.${i}.affiliation`}
                                    placeholder="Technology"
                                    labelName={`Speaker ${i + 1} affiliation`}
                                  />
                                  <InputField
                                    uni={`speakers.${i}.bio`}
                                    placeholder="Phd"
                                    labelName={`Speaker ${i + 1} bio`}
                                  />
                                </div>
                              </div>
                            ))}
                            <button
                              ...
                              className="bg-primary text-white px-2 py-1 self-end mt-4"
                            >
                              ADD SPEAKER
                            </button>
                      ...
                      <button
                        type="submit"
                        className=" bg-primary self-end rounded-sm p-1 text-white md: w-28 mt-4"
                      >
                        {!loading ? (
                          "Submit"
                        ) : (
