...
import AssignResearchPapers from '../../../components/pages/AssignResearchPapers';

const index = () => {
    return (
        <>
            <Head>
                <title>Research - Assign Research Papers</title>
                <meta charSet="utf-8" />
            ...
            <AssignResearchPapers></AssignResearchPapers>
        </>
    );
};
