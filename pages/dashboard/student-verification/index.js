...
import VerificationStudent from '../../../components/pages/VerificationStudent';

const index = () => {
    return (
        <>
        <Head>
            <title>Research - Verification Corner</title>
            <meta charSet="utf-8" />
            ...
            <meta property="og:title" content="Research - HOME" />
