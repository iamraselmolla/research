...
import StorageFacilities from "../../components/pages/StorageFacilities";

const index = () => {
  return (
    <>
      <Head>
       <title>3PL Warehouse Servicez - Storage Facilities</title>
        <meta charSet="utf-8" />
        ...
        <meta property="og:title" content="3PL Warehouse Servicez - Storage Facilities" />
            <meta name="keywords" content="3PL warehouse services,3PL warehouse servicez,sikka warehouse,sikka and associates,warehouses,best warehouses,3PL warehouse storage facilities" />
