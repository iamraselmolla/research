...
import LogisticsService from "../../components/pages/LogisticsService";

const index = () => {
  return (
    <>
      <Head>
        <title>3PL Warehouse Servicez - Logistics Service</title>
        <meta charSet="utf-8" />
        ...
        <meta property="og:title" content="3PL Warehouse Servicez - Logistics Service" />
            <meta name="keywords" content="3PL warehouse services,3PL warehouse servicez,sikka warehouse,sikka and associates,warehouses,best warehouses,3PL warehouse logistics service" />
