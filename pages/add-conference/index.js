...
import AddAConferenceByUnknownUser from '../../components/pages/AddAConferenceByUnknownUser';
...
const index = () => {
    return (
        <>
            ...
            <Head>
                <title>Research - Add a conference</title>
                <meta charSet="utf-8" />
            ...
            <AddAConferenceByUnknownUser></AddAConferenceByUnknownUser>
        </>
    );
};
